...
namespace ModelLibrary.Models.Kupon {
    ...
    public class Kupon : IKupon {
        ...
        // Metode til at udregne alle valgte kampe på kuponen, og give et samlet odds retur. oddsResultat er kampene lagt sammen der så ganges med hinanden for at få det samlet odds.
        ...
        // Metoder der genbruger OddsUdregning og ganger den med det ønsket antal point som brugeren ønsker at bruge på kuponen. Math.Round runder gevisten op således der kun er 2(Derfor: point,2) decimaler i den mulige gevinst.
